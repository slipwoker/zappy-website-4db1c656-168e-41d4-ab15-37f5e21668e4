...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (contactForm) {
    ...
    const validateField = (input) => {
      ...
      const isRTL = document.documentElement.dir === 'rtl' || document.documentElement.lang === 'ar' || document.documentElement.lang === 'he';
      ...
      if (input.type === 'tel' && value) {
        ...
        if (!phoneRegex.test(value)) {
          showError(input, isRTL ? 'يرجى إدخال رقم هاتف صالح' : 'Please enter a valid phone number');
          return false;
        }
      }

      if (input.minLength && value.length < input.minLength) {
        showError(input, (isRTL ? 'الحد الأدنى ' + input.minLength + ' أحرف' : 'Minimum ' + input.minLength + ' characters required'));
        return false;
      }
  ...
  if (animatedElements.length > 0) {
    ...
    animatedElements.forEach((el) => {
      const hasInitialStyle = el.style.opacity !== '' || el.style.transform !== '';
      if (!hasInitialStyle && !el.classList.contains('visible') && !el.classList.contains('fade-in-visible')) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '4db1c656-168e-41d4-ab15-37f5e21668e4',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '4db1c656-168e-41d4-ab15-37f5e21668e4';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4db1c656-168e-41d4-ab15-37f5e21668e4';
